#!/usr/bin/python3
"""test module for command interpreter"""
import unittest
...
class TestHBNBCommand(unittest.TestCase):
    """Represent test class for HBNBCmd class.
    """
    @unittest.skipIf(
    ...
    def test_db_create(self):
        """Tests create command With DB storage.
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
    ...
    def test_db_show(self):
        """Tests show cmd with DB storage.
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
    ...
    def test_db_count(self):
        """Tests count cmd with DB storage.
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
            dbc = MySQLdb.connect(
